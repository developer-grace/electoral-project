...
int main()
{
	...
	{ 
		...
		{"Jenny Goodie\t", "1\t\t", "Greens\t\t","36\t","Melbourne\t", ""},
		{"Harry Badgoi\t", "2\t\t", "Liberal\t", "53\t", "Brighton\t", ""},
		{"Robert Miner\t", "3\t\t",  "Liberal\t", "61\t", "Carrum\t", ""},
		{"Samson Forresta\t", "4\t\t", "Greens\t\t", "39\t", "Hawthorn\t", ""},
		{"Elena Werker\t", "5\t\t", "Labour\t\t", "42\t", "Preston\t", ""},
		{"William Iamme\t", "6\t\t", "Independent\t", "29\t", "Essendon\t", ""},
		{"Isabelle \t", "7\t\t", "Labour\t\t", "47\t", "Ivanhoe\t", ""},
		{"David Doitte\t", "8\t\t", "Labour\t\t", "55\t", "", ""},
		{"Michael McGhie\t", "9\t\t", "Independent\t", "32\t", "", ""},
		{"Tara Bell\t", "10\t\t", "Liberal\t", "65\t", "", ""}
	};
